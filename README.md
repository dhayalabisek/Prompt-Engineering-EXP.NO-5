...
OUTPUT:
Naïve and basic prompts were tested across four scenarios: story generation, factual questions, summarization, and advice.

Naïve prompts produced short, simple responses with less detail.
